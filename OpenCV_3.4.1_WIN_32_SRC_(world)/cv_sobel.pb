...
#CV_DESCRIPTION = "Calculates the first, second, third, or mixed image derivatives using an extended Sobel operator." + #LF$ + #LF$ +
                  "SPACEBAR    " + #TAB$ + ": Vertical / Horizontal." + #LF$ + #LF$ +
