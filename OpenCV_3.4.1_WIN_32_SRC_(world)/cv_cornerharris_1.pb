...
#CV_DESCRIPTION = "Calculates a feature map for corner detection using the Harris edge detector." + #LF$ + #LF$ +
                  "TRACKBAR    " + #TAB$ + ": Adjust the detection."
  ...
  If FileSize(ImageFile) > 0
    ...
    *image.IplImage = cvLoadImage(ImageFile, #CV_LOAD_IMAGE_ANYDEPTH | #CV_LOAD_IMAGE_ANYCOLOR)
    ...
    If *resize\width > 200 And *resize\height > 200
      cvCreateTrackbar("Detection", #CV_WINDOW_NAME, @nCorner, 5, @CvTrackbarCallback())
          ...
          *harris = cvCloneImage(*resize)
          ...
          For y = 0 To *resize\height - 1
            For x = 0 To *resize\width - 1
              ...
              If harris\val[0] > Pow(100, (nCorner + 1) * -1) : cvCircle(*harris, x, y, 2, 0, 0, 255, 0, #CV_FILLED, #CV_AA, #Null) : EndIf
