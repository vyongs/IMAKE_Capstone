...
Global openCV, *save.IplImage, exitCV, lpPrevWndFunc, nStyle

#CV_WINDOW_NAME = "PureBasic Interface to OpenCV"
#CV_DESCRIPTION = "Stylize an image by applying various filters." + #LF$ + #LF$ +
                  "SPACEBAR    " + #TAB$ + ": Start the stylizing." + #LF$ +
...
Procedure RecursiveFilter(*style.CvMat, *horiz.CvMat, sigma_h.f)
  h = *style\rows
  w = *style\cols
