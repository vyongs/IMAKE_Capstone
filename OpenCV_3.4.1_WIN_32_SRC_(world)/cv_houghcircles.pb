...
#CV_DESCRIPTION = "Finds circles in a grayscale image using the Hough transform." + #LF$ + #LF$ +
                  "SPACEBAR    " + #TAB$ + ": Toggle circles ON / OFF."
    ...
    *param\Value = window_handle
    ...
    Repeat
      If *resize
        ...
        If keyPressed = 32 : circles ! #True : EndIf
