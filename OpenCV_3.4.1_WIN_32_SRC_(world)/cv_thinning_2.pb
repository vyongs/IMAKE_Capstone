...
#CV_DESCRIPTION = "Repeated iterations using multiple filters on a grayscale image producing a skeleton effect." + #LF$ + #LF$ +
                  "SPACEBAR    " + #TAB$ + ": Start skeleton process." + #LF$ +
