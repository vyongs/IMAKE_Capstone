...
#CV_DESCRIPTION = "Calculates the distance to the closest zero pixel for each pixel in the image." + #LF$ + #LF$ +
                  "SPACEBAR    " + #TAB$ + ": Add / Remove normalize." + #LF$ + #LF$ +
          ...
          *reset = cvCloneImage(*color)
          ...
          Select keyPressed
            Case 32
              ...
              If nNormalize : cvNormalize(*distance, *distance, 0, 1, #NORM_MINMAX, #Null) : EndIf
