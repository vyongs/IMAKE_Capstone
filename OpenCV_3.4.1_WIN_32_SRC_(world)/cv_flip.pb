...
#CV_DESCRIPTION = "Flips a 2D array around vertical, horizontal, or both axes." + #LF$ + #LF$ +
                  "TRACKBAR    " + #TAB$ + ": Adjust the axes." + #LF$ +
                  "SPACEBAR    " + #TAB$ + ": Flip the axes."
  ...
  If FileSize(ImageFile) > 0
    ...
    *image.IplImage = cvLoadImage(ImageFile, #CV_LOAD_IMAGE_ANYDEPTH | #CV_LOAD_IMAGE_ANYCOLOR)
    ...
    If *resize\width > 200 And *resize\height > 200
      cvCreateTrackbar("Flip Image", #CV_WINDOW_NAME, @nFlip, 2, @CvTrackbarCallback())
      ...
      *param\Value = window_handle
      ...
      Repeat
        If *resize
          ...
          If keyPressed = 32 : cvFlip(*resize, #Null, nFlip - 1) : EndIf
