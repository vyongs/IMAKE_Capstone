...
Global openCV, *save.IplImage, exitCV, lpPrevWndFunc, nFlag, nAnchor, Dim srcPoint.CvPoint2D32f(3), Dim dstPoint.CvPoint2D32f(3)

#CV_WINDOW_NAME = "PureBasic Interface to OpenCV"
#CV_DESCRIPTION = "Calculates an affine transform from three pairs of corresponding points." + #LF$ + #LF$ +
