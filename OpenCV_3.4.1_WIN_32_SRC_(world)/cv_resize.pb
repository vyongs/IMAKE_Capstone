...
#CV_DESCRIPTION = "Resizes an image to a specified percent." + #LF$ + #LF$ +
                  "SPACEBAR    " + #TAB$ + ": Increase size by 10%."
...
Procedure OpenCV(ImageFile.s, nRatio.d)
