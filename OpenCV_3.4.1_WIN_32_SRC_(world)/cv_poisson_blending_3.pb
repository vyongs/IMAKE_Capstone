...
#CV_DESCRIPTION = "Using a Poisson blending algorithm, a monochrome transfer is achieved between two images." + #LF$ + #LF$ +
                  "SPACEBAR    " + #TAB$ + ": Add image / Blend images." + #LF$ +
...
Procedure ShowImage(*target.IplImage, *source.IplImage, x, y)
  scalar.CvScalar
...
Procedure OpenCV(ImageFile.s, nBlend)
