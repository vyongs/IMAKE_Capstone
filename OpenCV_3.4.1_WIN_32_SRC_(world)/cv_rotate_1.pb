...
#CV_DESCRIPTION = "Calculates an affine matrix of 2D rotation, applying the transformation to an image." + #LF$ + #LF$ +
                  "TRACKBAR    " + #TAB$ + ": Adjust the angle."
  ...
  If FileSize(ImageFile) > 0
    ...
    *image.IplImage = cvLoadImage(ImageFile, #CV_LOAD_IMAGE_ANYDEPTH | #CV_LOAD_IMAGE_ANYCOLOR)
    ...
    If *resize\width > 200 And *resize\height > 200
      cvCreateTrackbar("Degree", #CV_WINDOW_NAME, @nDegree, 360, @CvTrackbarCallback())
