...
#CV_DESCRIPTION = "Remaps an image to log-polar space." + #LF$ + #LF$ +
                  "TRACKBAR    " + #TAB$ + ": Adjust the magnitude." + #LF$ +
                  "SPACEBAR    " + #TAB$ + ": Toggle inverse map."
      ...
      *param\Value = window_handle
      ...
      Repeat
        If *polar
          ...
          If keyPressed = 32 : polar ! #True : EndIf
