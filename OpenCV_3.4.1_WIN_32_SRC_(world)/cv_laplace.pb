...
#CV_DESCRIPTION = "Calculates the Laplacian of an image." + #LF$ + #LF$ +
                  "TRACKBAR    " + #TAB$ + ": Adjust aperture size." + #LF$ + #LF$ +
  ...
  If FileSize(ImageFile) > 0
    ...
    *image.IplImage = cvLoadImage(ImageFile, #CV_LOAD_IMAGE_ANYDEPTH | #CV_LOAD_IMAGE_ANYCOLOR)
    ...
    If *resize\width > 200 And *resize\height > 200 And *resize\nChannels = 3
      cvCreateTrackbar("Aperture", #CV_WINDOW_NAME, @nAperture, 3, @CvTrackbarCallback())
      ...
      *param\Value = window_handle
      ...
      Repeat
        If *resize
          cvLaplace(*reset, *resize, nAperture * 2 + 1)
