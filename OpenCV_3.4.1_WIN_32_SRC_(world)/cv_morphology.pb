...
#CV_DESCRIPTION = "Performs advanced morphological transformations using a specific structuring element." + #LF$ + #LF$ +
                  "TRACKBAR    " + #TAB$ + ": Adjust the iterations." + #LF$ +
                  "SPACEBAR    " + #TAB$ + ": Change the element." + #LF$ + #LF$ +
                  "[ O ] KEY   " + #TAB$ + ": Morphological operations."
  ...
  If FileSize(ImageFile) > 0
    ...
    *image.IplImage = cvLoadImage(ImageFile, #CV_LOAD_IMAGE_ANYDEPTH | #CV_LOAD_IMAGE_ANYCOLOR)
    ...
    If *resize\width > 200 And *resize\height > 200
      cvCreateTrackbar("Iterations", #CV_WINDOW_NAME, @nPosition, 21, @CvTrackbarCallback())
