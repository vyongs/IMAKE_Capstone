...
Global *save.IplImage, exitCV, lpPrevWndFunc, nDepth

#CV_WINDOW_NAME = "PureBasic Interface to OpenCV"
#CV_DESCRIPTION = "Using a second image as a mask to compare against an object in the original image, depth of field is simulated." + #LF$ + #LF$ +
                  "SPACEBAR    " + #TAB$ + ": Start the simulation." + #LF$ +
...
Procedure DepthFilter(*depth.CvMat, *horiz.CvMat, radius.f)
  myinf.d = 9.9e307
  h = *depth\rows
  w = *depth\cols
...
Procedure DepthOfField(*image.IplImage, sigma_s.f, sigma_r.f, *mask.IplImage)
  iterations = 3
  w = *mask\width
  h = *mask\height
	channel = *mask\nChannels
