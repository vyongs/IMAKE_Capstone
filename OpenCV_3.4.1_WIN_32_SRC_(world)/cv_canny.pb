...
#CV_DESCRIPTION = "Finds edges in an image using the Canny86 algorithm." + #LF$ + #LF$ +
                  "TRACKBAR    " + #TAB$ + ": Adjust the threshold." + #LF$ +
                  "SPACEBAR    " + #TAB$ + ": Toggle color ON / OFF."
  ...
  If FileSize(ImageFile) > 0
    ...
    *image.IplImage = cvLoadImage(ImageFile, #CV_LOAD_IMAGE_ANYDEPTH | #CV_LOAD_IMAGE_ANYCOLOR)
    ...
    If *resize\width > 200 And *resize\height > 200 And *resize\nChannels = 3
      cvCreateTrackbar("Threshold", #CV_WINDOW_NAME, @nThreshold, 100, @CvTrackbarCallback())
      ...
      *param\Value = window_handle
      ...
      Repeat
        If *canny
          ...
          If keyPressed = 32 : canny ! #True : EndIf
