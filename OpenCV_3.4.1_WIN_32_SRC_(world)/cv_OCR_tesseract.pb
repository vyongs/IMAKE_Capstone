...
#CV_DESCRIPTION = "Using Tesseract OCR (Optical Character Recognition) an image of numbers is translated to text." + #LF$ + #LF$ +
                  "SPACEBAR    " + #TAB$ + ": Execute OCR."
    ...
    Repeat
      If *resize
        ...
        If keyPressed = 32
          ...
          If hAPI
            textOCR.s = OpenCVImage2TextOCR(hAPI, *resize)
