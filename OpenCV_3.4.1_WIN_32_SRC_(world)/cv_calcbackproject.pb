...
#CV_DESCRIPTION = "Calculating the back projection of a histogram, frequent density values are displayed as bright pixels." + #LF$ + #LF$ +
    ...
    *image.IplImage = cvLoadImage(ImageFile, #CV_LOAD_IMAGE_ANYDEPTH | #CV_LOAD_IMAGE_ANYCOLOR)
    ...
    If *resize\width > 200 And *resize\height > 200 And *resize\nChannels = 3
      *gray.IplImage = cvCreateImage(*resize\width, *resize\height, #IPL_DEPTH_8U, 1)
      ...
      Dim *ranges.FLOAT(2) : PokeL(@*ranges(0), @range1()) : PokeL(@*ranges(1), @range2())
      *hist.CvHistogram = cvCreateHist(2, @bins(), #CV_HIST_ARRAY, @*ranges(), #True)
