...
def random_Fire():
    random = randint(1,7)
    if random == 1:
        temp = Fire_type1(randint(100,W-100), randint(100,H)) #init <-- x,y,qty
        fires.append(temp)
    elif random == 2:
        temp = Fire_type2(randint(100,W-100), randint(100,H)) #init <-- x,y,qty
        fires.append(temp)
    elif random == 3:
        temp = Fire_type3(randint(100,W-100), randint(100,H)) #init <-- x,y,qty
        fires.append(temp)
    elif random == 4:
        temp = Fire_type4(randint(100,W-100), randint(100,H)) #init <-- x,y,qty
        fires.append(temp)
    elif random == 5:
        temp = Fire_type5(randint(100,W-100), randint(100,H)) #init <-- x,y,qty
        fires.append(temp)
    elif random == 6:
        temp = Fire_type6(randint(100,W-100), randint(100,H)) #init <-- x,y,qty
        fires.append(temp)
    elif random == 7:
        temp = Fire_type7(randint(100,W-100), randint(100,H)) #init <-- x,y,qty
        fires.append(temp)
#--------------------main
TARGET_FPS = 20
