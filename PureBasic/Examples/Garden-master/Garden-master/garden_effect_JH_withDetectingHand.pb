...
Declare CvMouseCallback(event, x.l, y.l, flags, *param.CvUserData)
Declare GetConvexHull(*image, *contours)
Declare DetectFingers(*image.IplImage, *contours.CvSeq, centerX, centerY)
Declare DetectHand(*image.IplImage, *contours.CvSeq)
Declare xyExtract()
Declare Exit()
...
Procedure RenderGame2D()
  ; DisplayTransparentSprite(Pointer, WindowMouseX(myWindow)-75, WindowMouseY(myWindow)-75)
  DisplayTransparentSprite(Pointer, handX-75, handY-75)
...
Procedure DetectHand(*image.IplImage, *contours.CvSeq)
  ...
  handX = minCircleCenter\x
  handY = minCircleCenter\y
